...
class CsvLogger:
    ...
    def plot_progress_errk(self, claimed_acc=None, title='PNI', k=1):
        if self.dummy:
            pass
    ...
    def plot_progress_loss(self, title='PNI'):
        if self.dummy:
            pass
        plt.figure(figsize=(9, 8), dpi=300)
    ...
    def plot_progress(self, claimed_acc1=None, claimed_acc5=None, title='PNI'):
        if self.dummy:
            pass
